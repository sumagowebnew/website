...
export default function Contact() {
  ...
  const SubmitData = (e) => {
    ...
    axios
      .post("http://localhost/main-main/main/contact/add", newData)
      .then((resp) => {
        ...
        <div className="row mt-5 ms-md-5 ms-0 container mb-5">
          ...
          <div className="col-lg-5 col-md-5 col-12 p-3 p-lg-5 p-md-3 back text-start rounded-3 image">
            ...
            <p className="" style={{ textAlign: "justify" }}>
              If you would like to find out more about what Sumago Infotech can
              do for your business or to receive a project quote,don't hesitate
              to contact us.
            </p>
            ...
            <hr className="w-75" style={{ backgroundColor: "white" }} />
            ...
            <div className="d-flex justify-content-space-around mt-2">
              ...
              <div className="ms-3">
                <p>
                  <a
                    href="mailto:infotech@sumagoinfotech.com"
                ...
                <p>
                  <a
                    href="mailto:sumagoinfotech@gmail.com"
                    class="link-underline-primary"
                  >
                    {" "}
                    sumagoinfotech@gmail.com{" "}
                  </a>
                </p>
              </div>
            </div>
            ...
            <div className="d-flex justify-content-space-around mt-2">
              ...
              <div className="ms-3">
                <div>
                  3rd Floor, Gajra Chambers, Kamod Nagar, Indira Nagar, Near
                  Hotel Sai Saya, Nashik-422009
                </div>
              </div>
            </div>
          </div>
